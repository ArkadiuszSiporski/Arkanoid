 ...
 */
public class DisplayHighscoresImpl extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		String output = internationalizer.getString("noRecords");
			...
			if(i == 1)
			{
				(SwingUtilities.getRoot(DisplayHighscoresImpl.this)).setBounds(140, 0, 850, 150);
			...
			{
				(SwingUtilities.getRoot(DisplayHighscoresImpl.this)).setBounds(400, 0, 400, i *80 );
			}
		}
	}
	/**
	...
	private class Controls extends AbstractAction
	{
		...
		{
			Main main = ((Main)SwingUtilities.getRoot(DisplayHighscoresImpl.this));
			//back to menu
			if(action)
			{
				initialized = false;
