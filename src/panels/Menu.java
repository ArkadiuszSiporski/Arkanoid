...
import main.Main;
/**
 * Class that implements menu panel in which we can choose the mode we want to play, display highscores or exit the game.
 *
 */
public class Menu extends JPanel
{
	...
	/**
	 * Constructor sets up Key Bindings and invokes method to set up all used buttons.
	 */
	public Menu()
	{
	 ...
	 * @param text what should be written on a particular button
	 * @return returns the created button's reference
	 */
	private JButton setButtons(String text)
	{
		Dimension max = new Dimension(300, (275-15)/4);
