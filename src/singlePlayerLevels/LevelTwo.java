...
public class LevelTwo extends NormalLevel {
	...
	/**
	 * Constructor sets up Key Bindings, reference to third level and JFrame in
	 * which the panel is displayed.
	 * 
	 * @param main
	 *            JFrame in which the panel is displayed.
	 * @param thirdLevel
	 *            reference to label representing next level
	 */
	...
	/**
	 * Increses meteor's timer and checks for impact between meteor and the
	 * paddle.
	 */
	public void actionPerformed(ActionEvent e) {
		if (play) {
