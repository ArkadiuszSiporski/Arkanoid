...
public class LevelThree extends CoreLevel
{
	...
	/**
	 * Paints background, paddle, meteor, target and game result. Calls super class' paint method.
	...
	public void paint(Graphics g)
	{
		...
		if(gameState == WON)
		{
			...
			g.drawString("CONGRATULATIONS", 150, 500);
			g.setFont(new Font("Serif", Font.BOLD, 30));
			g.drawString("YOU FINISHED THE GAME!!", 300, 600);
		}
		super.paint(g);
	}
	/**
	 * Controls the game - increases  target's timer, decreases score overtime, checks for impacts between ball and paddle/target,
	 * checks if the ball is still in the playground.
	 */
	...
	/**
	 * Ends game when the player broke the target, calls super class' victory method.
	 */
